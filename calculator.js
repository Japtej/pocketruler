...
[Your Name]`;
  ...
  function initModals() {
    ...
    const embedCode = `<iframe src="${url}" width="100%" height="850" style="border:0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);" title="Freelance Rate vs. Retainer Calculator" loading="lazy"></iframe><p style="font-size:12px;text-align:center;margin-top:8px;color:#64748b;">Free tool by <a href="${url}" target="_blank" style="color:#059669;text-decoration:underline;">Freelance Rate vs. Retainer Calculator</a></p>`;
